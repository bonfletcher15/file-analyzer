...
const RegisterForm = () => {
  ...
  return (
    <form action={() => {handleRegister(formData); }} className="bg-white flex flex-col p-8 rounded-xl shadow-lg w-96 mx-auto mt-20 gap-6">
      <h1 className="text-3xl font-semibold text-center mb-2 text-gray-800">Register</h1>
      ...
      <div className="text-center">
        <Link href="/login" className="text-black-400 hover:text-blue-900 transition-all">
